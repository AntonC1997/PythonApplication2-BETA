...
def execute_engine(file_path, output_text):
    if file_path:
        ...
        process = subprocess.Popen([r"C:\Users\indus\source\repos\YouTube\How to create YOUR own Antivirus software\engine.c", file_path], stdout=subprocess.PIPE, universal_newlines=True)
...
def execute_engine_rtm(file_path, output_text):
    if file_path:
        ...
        # Execute engine.exe and capture output
        file_label.config(text=file_path)
        process_rtm = subprocess.Popen([r"C:\Users\indus\source\repos\YouTube\How to create YOUR own Antivirus software\engine.c", file_path], stdout=subprocess.PIPE, universal_newlines=True)
...
def toggle_win():
    ...
    global menu_close
    tmp_pic = Image.open(r"C:\Users\indus\source\repos\YouTube\How to create YOUR own Antivirus software\images\menu_close.png")
...
tmp_pic = Image.open(r"C:\Users\indus\source\repos\YouTube\How to create YOUR own Antivirus software\images\menu_open.png")
resized_tmp_pic = tmp_pic.resize((50, 50), Image.LANCZOS)
...
#root page
my_label = Label(root, text="IndusSec", font=("Helvetica", 60, "bold"), bg="#262626", fg="white")
...
upload_image = Image.open(r"C:\Users\indus\source\repos\YouTube\How to create YOUR own Antivirus software\images\upload_image.png")
